...
{"intent": "reminder"|"habit"|"note"|"things"|"today_tasks"|"crypto"|"search"|"question"|"stats"|"list"|"habits_list"|"notes_list"|"help"}
...
- today_tasks: ПРИОРИТЕТ когда спрашивают про задачи из Things 3 на сегодня.
  Триггеры: "задачи на сегодня", "что у меня сегодня", "покажи сегодняшние задачи",
  "что запланировано на сегодня", "мои задачи сегодня", "что надо сделать сегодня",
  "план на сегодня", "список на сегодня", "задачи в Things", "Things на сегодня",
  "Финкс задачи", "покажи Things", "что в Things", "задачи из Things", "финкс на сегодня"
  ЛЮБОЙ вопрос про задачи из Things 3 на текущий день → today_tasks!
- stats: статистика/отчёт ("статистика", "итоги", "как я справляюсь")
- list: список напоминаний Марвела (НЕ Things 3)
